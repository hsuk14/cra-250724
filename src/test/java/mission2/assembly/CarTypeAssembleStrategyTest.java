...
class CarTypeAssembleStrategyTest {
    ...
    void assembleByCommand(){
        // given
        CarTypeAssembleStrategy assembleStrategy = new CarTypeAssembleStrategy();
        Car testCar = new Car();
        ...
        // then
        assertTrue(outputStreamCaptor.toString().contains("차량 타입으로"));
    }
