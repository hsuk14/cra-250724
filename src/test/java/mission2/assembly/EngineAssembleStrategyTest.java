...
class EngineAssembleStrategyTest {
    ...
    void assembleByCommand(){
        // given
        EngineAssembleStrategy assembleStrategy = new EngineAssembleStrategy();
        Car testCar = new Car();
        ...
        // then
        assertTrue(outputStreamCaptor.toString().contains("엔진을 선택"));
    }
